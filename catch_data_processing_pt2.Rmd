...
```{r}
summary_table <- data.frame("Obs" = c(nrow(indo_total), nrow(indo_catchInd_grouped),
                                      nrow(indo_catchNInd_grouped), nrow(indo_total),
                                      nrow(indo_catchInd_grouped),
                                      nrow(indo_catchNInd_grouped)),
                            "Mean" = c(mean(indo_total$total_catch),
                                       mean(indo_catchInd_grouped$sum_reported),
                                       mean(indo_catchNInd_grouped$sum_reported),
                                       mean(indo_total$total_IUU_catch),
                                       mean(indo_catchInd_grouped$sum_IUU),
                                       mean(indo_catchNInd_grouped$sum_IUU)),
                            ...
                            "Min" =  c(min(indo_total$total_catch),
                                       min(indo_catchInd_grouped$sum_reported),
                                       min(indo_catchNInd_grouped$sum_reported),
                                       min(indo_total$total_IUU_catch),
                                       min(indo_catchInd_grouped$sum_IUU),
                                       min(indo_catchNInd_grouped$sum_IUU)),
                            "Max" =  c(max(indo_total$total_catch),
                                       max(indo_catchInd_grouped$sum_reported),
                                       max(indo_catchNInd_grouped$sum_reported),
                                       max(indo_total$total_IUU_catch),
                                       max(indo_catchInd_grouped$sum_IUU),
                                       max(indo_catchNInd_grouped$sum_IUU)))
